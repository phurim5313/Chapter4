...
{
[SerializeField]GameObject _itemToBeSpawn;
[SerializeField]GameObject[] _obstaclesToBeSpawn;
    ...
    void SpawnItem()
    {
        GameObject go = Instantiate(_itemToBeSpawn,new Vector3(Random.Range(-4.5f, 4.5f), 5, 0),
        Quaternion.identity);
        Destroy(go, 5);
